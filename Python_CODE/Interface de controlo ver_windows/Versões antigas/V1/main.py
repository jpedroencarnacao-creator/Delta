...
def route_desligar():
    """Diz ao browser para fechar só o separador atual.
    O servidor Flask continua a correr — os outros separadores não são afetados."""
    # Devolve um script que fecha só o separador que fez o pedido
    return Response(
...
def route_movements_calcular():
    ...
    try:
        ...
        resultado = cm.gerar_graficos(params_c1, params_c2)
        ...
        return jsonify({'ok': True, 'img': resultado['img'],
