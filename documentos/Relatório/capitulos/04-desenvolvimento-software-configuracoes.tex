...
\subsection{Geração de trajetórias na HMI (Python/Raspberry Pi)}
...
\subsection{Execução dos perfis no modelo dinâmico (C++/ESP32)}
...
\section{Máquina de estados de execução dos movimentos}
