...
Deixo aqui o meu maior e mais sincero agradecimento ao meu orientador:

\begin{center}
\textbf{Professor Jorge Semião}
\end{center}

por me ter dado a oportunidade de trabalhar num projeto tão desafiante e interessante, por ter demonstrado sempre disponibilidade para ajudar e por todo o apoio prestado ao longo do desenvolvimento deste trabalho.
...
Gostaria ainda de agradecer a todos os professores, colegas e amigos da Licenciatura em Engenharia de Eletrotecnia e Computadores, por todo o apoio, pela entreajuda e pela presença ao longo deste percurso académico.
...
\begin{description}
  ...
  \item[DEV] \textit{Development}; modo de utilização da HMI que dá acesso a ferramentas de debugging e de envio manual de comandos.
  ...
  \item[USB-C] \textit{Universal Serial Bus Type-C}; conetor universal usado para alimentação e transferência de dados.
\end{description}
